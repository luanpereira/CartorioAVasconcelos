<%@ Page Language="VB" MasterPageFile="~/CARTORIO.master" AutoEventWireup="false" CodeFile="CasamentoReligioso.aspx.vb" Inherits="pages_Documentacao_CasamentoReligioso" %>
        ...
        <div id="FormNascimento" class="boxes">            
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <h2>Emissão de Certidão de Casamento Religioso</h2>
                    <fieldset>
                            ...
                            <asp:Panel ID="Panel5" runat="server" Height="104%" Width="494px" 
                                ...
                                <p>
                                    ...
                                    <asp:TextBox ID="txtTipoLivro" runat="server" CssClass="texto" MaxLength="1" 
                                        Text="3" Width="30px" Enabled="False"></asp:TextBox>
                                </p>                                
                                <p>
