...
Partial Class pages_Documentacao_Casamento
    ...
    Private Sub listarDadosPedido(ByVal id As Integer)
        ...
        Try
            ...
            Me.listarDadosCliente(CType(pedido.Documento, Casamento).Casal)

            Me.txtDataRegistro.Text = pedido.Documento.DataRegistro
            Me.txtEmissao.Text = pedido.DataEmissao
            Me.txtNovoNome1.Text = CType(pedido.Documento, Casamento).NovoNomeConjuge1
            Me.txtNovoNome2.Text = CType(pedido.Documento, Casamento).NovoNomeConjuge2
            Me.drpRegime.SelectedValue = CType(pedido.Documento, Casamento).Regime
            ...
            ViewState("CasamentoID") = pedido.Documento.Codigo
    ...
    Protected Sub imgPesqConjuge_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgPesqConjuge.Click
        Session("casamento") = ViewState("casal")
    ...
    Private Sub salvar()
        ...
        Try
            ...
            casamento.Codigo = IIf(ViewState("CasamentoID") Is Nothing, 0, ViewState("CasamentoID"))
    ...
    Protected Sub btnSalvar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSalvar.Click
        Try
            ...
            CType(CType(Session("pedido"), Pedido).Documento, Casamento).Casal.Conjuge1 = controller.listarClassCliente(CType(CType(Session("pedido"), Pedido).Documento, Casamento).Casal.Conjuge1)
            CType(CType(Session("pedido"), Pedido).Documento, Casamento).Casal.Conjuge2 = controller.listarClassCliente(CType(CType(Session("pedido"), Pedido).Documento, Casamento).Casal.Conjuge2)

            Response.Redirect("~/pages/Documentacao/CasamentoReport.aspx")
