...
Namespace Infraestrutura
    ...
    Public Class Utils
        ...
        Public Shared Function getMes(ByVal n As Int16) As String
            Select Case n
                Case 1
                    Return "Janeiro"
                Case 2
                ...
                Case 12
                    Return "Dezembro"
                Case Else
                    Return "N˙mero n„o correspondente"
            End Select
        End Function
        ...
        Public Shared Sub completarZeros(ByRef txt As TextBox)
            Dim zeros As String = ""
        ...
        ''' <summary>
        ''' FunÁ„o principal que recolhe o valor e chama as duas funÁıes
        ''' auxiliares para a parte inteira e para a parte decimal
        ''' </summary>
        ''' <param name="number">N˙mero a converter para extenso (Reais)</param>
        ''' 
        Public Shared Function numeroPorExtenso(ByVal number As Decimal) As String
            Dim cent As Integer
            Try
        ...
        Private Shared Function getDecimal(ByVal number As Byte) As String
            Try
                Select Case number
                    Case 0
                        Return ""
                    Case 1 To 19
                        Dim strArray() As String = _
                           {"Um", "Dois", "TrÍs", "Quatro", "Cinco", "Seis", _
        ...
        Private Shared Function getInteger(ByVal number As Decimal) As String
            Try
                number = Int(number)
                Select Case number
                    Case Is < 0
                    ...
                    Case 1000000000 To 1999999999
                        Select Case (number Mod 1000000000)
                            Case 0
                                Return "Um Bilh„o"
                            Case Is <= 100
                                Return getInteger(number \ 1000000000) + "Bilh„o e " + getInteger(number Mod 1000000000)
                            Case Else
                                Return getInteger(number \ 1000000000) + "Bilh„o, " + getInteger(number Mod 1000000000)
                        End Select
                    Case Else
                        Select Case (number Mod 1000000000)
                            Case 0
                                Return getInteger(number \ 1000000000) + " Bilhıes"
                            Case Is <= 100
                                Return getInteger(number \ 1000000000) + "Bilhıes e " + getInteger(number Mod 1000000000)
                            Case Else
                                Return getInteger(number \ 1000000000) + "Bilhıes, " + getInteger(number Mod 1000000000)
                        End Select
                End Select
            Catch ex As Exception
                Return ""
